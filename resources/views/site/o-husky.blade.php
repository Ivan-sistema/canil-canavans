        ...
        <section class="container-full" id="o-husky">
            <div class="container">
                <x-title.title-section 
                        title="ORIGEM E HISTÓRIA DA RAÇA" 
                        conteudo="O Husky Siberiano é uma raça que tem origem na Sibéria, Rússia, na pré-história. A tribo nômade conhecida como Chukchi, foi responsável pela criação dos primeiros cachorros dessa raça, que na época já eram usados para o trabalho puxando trenós e para a caça." />
            </div>
            <div class="container">
              <div class="o-husky__content">
                    <article>
                      ...
                      <div class="conteudo-article">
                        <h2>Destaque</h2>
                        <p>Resistentes, rústicos e cheios de energia, os Huskies desembarcaram no Canadá em 1909 para disputar corridas de trenó. Logo se espalharam pelo Alasca, onde essas corridas eram comuns e se assemelhavam às corridas de cavalos. Os percursos chegavam até 600 km e os Huskies Siberianos sempre se destacavam por sua velocidade e resistência.</p> 
                        <p>A raça foi reconhecida em 1930 oficialmente pela American Kennel Club (AKC) e com isso, começou a se tornar cão de estimação de diversas famílias pelo mundo. Até hoje as maiores concentrações de Husky Siberiano se encontram no Ártico, onde seguem desenvolvendo suas funções de trabalho.</p>
                        <h2>Temperamento e Saúde</h2>
                        <p>Divertido, aventureiro, alerta, independente, inteligente, teimoso, travesso e obstinado. Tudo isso descreve o Husky Siberiano. Essa raça adora correr sempre que pode. Geralmente se dá bem com outros cães da casa. Na verdade, ele é um cão muito social que precisa da companhia de outros cães ou de seres humanos. Ele pode caçar gatos ou gado. Alguns uivam, cavam e roem.</p>
